export const projects = [
    ...
    
    {
      id: '1',
      title: 'CRM',
      description: 'Full-stack CRM platform with React frontend and Node.js backend for lead management, sales tracking, and business operations.',
    ...
    },
    {
      id: '2',
      title: 'Apex Shopping',
      description: 'Full-stack e-commerce solution with React, Node.js, and MongoDB. Features include user authentication, JWT, Google Auth, and admin dashboard.',
    ...
    },
  {
    ...
    description: 'A deep learning project to classify cat breeds using TensorFlow and Keras. Trained on a filtered subset of the Oxford-IIIT Pet dataset containing 12 cat breeds, and fine-tuned using transfer learning on Google Colab.',
    image: 'https://repository-images.githubusercontent.com/78960087/e08d0380-3538-11ea-8100-3c74cc52a2d8',
    technologies: ['Python', 'TensorFlow', 'Keras', 'Colab'],
    category: 'AI',
    githubUrl: 'https://github.com/shkumar156/Cat-Breed-Prediction-Using-Kaggle-Dataset',
